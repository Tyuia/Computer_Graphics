...
function ShipDoStep(){
	// computiamo l'evolversi della nave
	var vxm, vym, vzm; // velocita' 
	// da vel frame mondo a vel frame nave
	...
	vym*=attritoY;
	vzm*=attritoZ;
	// l'orientamento della nave segue quello dello sterzo
	...
	//****************************************************************************************************
	//GESTIONE OSTACOLI
	//suppongo che la nave provi ad uscire dal mondo solo in avanti e non in retro
	const stepBack = 20;
	if (px >= 485){
		px-=stepBack;
	}
...
function ShipInit(){
	// inizializzo lo stato della nave
	// posizione e orientamento
	px = 0; py = 270; pz = 15;
	facing = 0; //per vedere la parte frontale o posteriore della nave --> 0: posteriore, 180: anteriore
	sterzo = 0; 	// stato
